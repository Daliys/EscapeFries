	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord11.xyz = vertexToFrag27_g28;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 vertexToFrag27_g28 = IN.ase_texcoord11.xyz;
				...
				#endif
				float AlphaIn20_g28 = ( (temp_output_7_0_g25).a * staticSwitch50_g25 );
				...
				float Occlusion = 1;
				float Alpha = ( (temp_output_124_0).a * AlphaOut20_g28 );
				float AlphaClipThreshold = AlphaThreshold20_g28;
				float3 BakedGI = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag27_g28 = temp_output_183_21;
				o.ase_texcoord6.xyz = vertexToFrag27_g28;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 computeScreenPos18_g25 = ComputeScreenPos( unityObjectToClipPos17_g25 );
				float2 ScreenPos20_g28 = (( ( computeScreenPos18_g25 / (computeScreenPos18_g25).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g28 = IN.ase_texcoord6.xyz;
				float3 VertPos20_g28 = vertexToFrag27_g28;
				int VertexID5_g25 = IN.ase_texcoord2.z;
				float3 PositionLs5_g25 = float3( 0,0,0 );
				float3 NormalWs5_g25 = float3( 0,0,0 );
...
/*ASEBEGIN
Version=18100
-1542;209;1438;795;986.8251;361.1733;1.6;True;False
...
Node;AmplifyShaderEditor.IntNode;196;0,448;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;8;0;Create;True;0;0;False;0;False;256;256;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;194;0,544;Inherit;False;Property;_RandomDither;Random Dither;10;1;[Toggle];Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;195;0,224;Inherit;True;Property;_DitherTexture;Dither Texture;6;0;Create;True;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
ASEEND*/
//CHKSM=F6FEB34C23B2938AA0FE940CCC350AC71A057AA9